package com.fortune.zg.widget.loading
...
class LoadingView : View {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        init(context, attrs, 0, R.style.LoadingView)
    }
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        init(context, attrs, defStyleAttr, R.style.LoadingView)
    }
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        mMinHeight =
            a.getDimensionPixelSize(R.styleable.LoadingView_minHeight, mMinHeight)
        mMaxHeight =
            a.getDimensionPixelSize(R.styleable.LoadingView_maxHeight, mMaxHeight)
...
//    }
    ...
    companion object {
        ...
        private val DEFAULT_INDICATOR = BallClipRotatePulseIndicator()
